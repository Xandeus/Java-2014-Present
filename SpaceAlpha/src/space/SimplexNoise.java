...
public class SimplexNoise { // Simplex noise in 2D, 3D and 4D
	...
	public static double OctavePerlin(double x, double y, int octaves, double persistence, double frequency,
	...
	public static double noise(double x, double y, double z, double w) {
		...
		// [rankx, ranky, rankz, rankw] is a 4-vector with the numbers 0, 1, 2
		// and 3
